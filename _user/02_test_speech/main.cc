...
constexpr int kTensorArenaSize = 70 * 1024;  // 20 KB, dostosuj wg potrzeb
...
void FillInput(TfLiteTensor* input, bool loud) {
  // micro_speech wejście: int8_t, kształt np. [1,49,10,1]
  int8_t v = loud ? 10 : 0;
